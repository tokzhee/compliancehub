-- ============================================================================
-- UNIFIED FATCA/CRS REGULATORY SCREENING VIEW
-- Created: 2026-02-22
-- Purpose: Harmonised DWH-facing view combining Individual and Entity customers
--          for FATCA and CRS rule engine filtering and XML generation
-- ============================================================================
