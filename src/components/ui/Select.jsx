    ...
    return (
        <div className={cn("relative", className)}>
            ...
            <div className="relative">
                ...
                {/* Dropdown */}
                {isOpen && (
                    <div className="absolute z-50 w-full mt-1 bg-card border border-border rounded-md shadow-md">
                        {searchable && (
                                ...
                                filteredOptions?.map((option) => (
                                    <div
                                        ...
                                        className={cn(
                                            ...
                                            isSelected(option?.value) ? "bg-primary text-white font-medium" : "text-gray-900 dark:text-gray-100",
