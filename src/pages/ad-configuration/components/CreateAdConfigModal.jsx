...
const CreateAdConfigModal = ({ isOpen, onClose, onCreateConfig }) => {
  ...
  const handleSubmit = async (e) => {
    ...
    // Construct ldapServerUrl from host, port, and SSL settings
      ...
      <div className="bg-card rounded-lg shadow-elevation-xl w-full max-w-2xl max-h-[90vh] overflow-y-auto transition-colors">
        <div className="flex items-center justify-between p-4 md:p-6 border-b border-border bg-card transition-colors">
          <div className="flex items-center gap-3">
            ...
            <div>
              <h2 className="text-lg md:text-xl font-semibold text-foreground transition-colors">Create LDAP Configuration</h2>
              <p className="text-xs md:text-sm text-muted-foreground mt-1 transition-colors">
                Configure directory integration settings
              </p>
            </div>
          </div>
          <button
...
export default CreateAdConfigModal;